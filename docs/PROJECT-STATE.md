...
Last updated: 2026-09-21 (Production release `9ccedc7` is live as Vercel deployment `dpl_9T2ieXVW64cybVSUna1Z694725Yn`; CI and local release gates are green. The bounded Ontario white-tailed deer opportunity API is deployed and certified as PARTIAL DATA with no legal-status claim. Its PostGIS foundation migration remains intentionally unapplied and no map UI, Crown/public-land geometry, or Québec serving switch was included. Ontario 7/7, Alberta 13/13 and Manitoba 24/24 production regressions agree with the law. Québec remains certified but not served pending the owner's separately documented approval steps.)
