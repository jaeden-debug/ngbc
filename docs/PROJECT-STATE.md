...
- **Population: 59 of 60.** All 59 active assets have a cover rendition (57 backfilled from their sanitized masters, 2 published with one). Only `species:arctic-hare` has no photograph; no file has been supplied.
