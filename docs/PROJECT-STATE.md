...
Last updated: 2026-09-21 (The four served Hunt zone layers are authority-first certified end to end; Québec Zone 18 source drift was losslessly normalized and promoted, sparse-edge boundary distance is corrected, and map delivery now count-checks every authority viewport. Canonical species PRIMARY media activation remains separately blocked on its ordered migration and provisioning work.)
