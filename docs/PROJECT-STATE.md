...
Last updated: 2026-09-21 (Canonical species PRIMARY media is implemented locally and validated through authenticated first upload; production activation remains blocked on an ordered migration deploy, private-bucket provisioning and administrator credentials. Ready to Hunt remains production-certified in the current live release.)
